...
const NAV = [
  {
    section: 'Overview',
    links: [{ to: '/seller', label: 'Dashboard', icon: LayoutDashboard, end: true }],
  },
  {
    section: 'My store',
    links: [
...
const PAGE_META = {
  '/seller': { title: 'Dashboard', subtitle: 'Your store performance at a glance' },
  '/seller/products': { title: 'Products', subtitle: 'List, edit and track your catalogue' },
  '/seller/orders': { title: 'Orders', subtitle: 'Orders placed by customers on your products' },
};
...
function getPageMeta(pathname) {
  ...
  return PAGE_META[match] || { title: 'Seller center', subtitle: 'Manage your store' };
}
      ...
      <div className="border-t border-white/10 p-3">
        ...
        <div className="rounded-2xl bg-white/5 p-3 ring-1 ring-inset ring-white/10">
          <div className="flex items-center gap-3">
            <span className="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl bg-gradient-to-br from-amber-400 to-amber-600 text-sm font-bold text-ink ring-1 ring-white/20">
              {initials}
            </span>
      ...
      <div className="lg:pl-72">
        <header className="sticky top-0 z-30 flex h-16 items-center gap-3 border-b border-slate-200/80 bg-white/85 px-4 backdrop-blur-xl sm:px-6 lg:h-[4.5rem]">
          ...
          <div className="ml-auto flex items-center gap-2 sm:gap-3">
            ...
            <span className="flex h-10 w-10 items-center justify-center rounded-xl bg-gradient-to-br from-amber-400 to-amber-600 text-sm font-bold text-ink shadow-glow ring-2 ring-white">
              {initials}
            </span>
          </div>
        </header>
